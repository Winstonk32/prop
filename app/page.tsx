  ...
  const steps = [
    ...
    <motion.div key="step0" className="text-center" {...fadeInUp}>
      ...
      <motion.img
        ...
        transition={{ duration: 0.5 }}
        src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExZXVxYjhqY2tqZ3UxdHR5ZTFzamJ1cWE1azFibGMxcnlod2tzaHYyZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/gKHGnB1ml0moQdjhEJ/giphy.webp"
    ...
    <motion.div key="step1" className="text-center" {...fadeInUp}>
      ...
      <motion.img
        ...
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5 }}
        src="https://media1.tenor.com/m/uQC0doa0t3UAAAAd/garfield.gif"
        alt="Excited bear gif"
        className="w-full max-w-md mx-auto mb-4 rounded-lg shadow-lg"
      />
